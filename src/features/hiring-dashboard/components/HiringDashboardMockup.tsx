...
const mockCandidates: Candidate[] = [
  {
    ...
    avatarColor: '#10b981',
    aiRanking: '🏆 **Archetype:** The Product Visionary\n\n🟢 **Superpower:** Exceptional product & business sense (9.9/10) shows rare ability to translate user needs into technical solutions. Strong robustness & quality (8.0/10) ensures reliable feature delivery.\n\n⚠️ **Trade-off:** Limited experience with large-scale distributed systems (5.0/10) may require support on high-throughput infrastructure challenges.',
    spiderMap: [
      { label: 'Product & Business Sense', value: 9.9 },
      { label: 'Communication & Impact', value: 7 },
      { label: 'Scale & Complexity', value: 5 },
      { label: 'Velocity & Focus', value: 6 },
      { label: 'Robustness & Quality', value: 8 },
    ],
  ...
  },
  {
    ...
    title: '',
    avatarColor: '#3b82f6',
    aiRanking: '🏆 **Archetype:** The Storyteller Engineer\n\n🟢 **Superpower:** Outstanding communication & impact (8.5/10) with exceptional ability to explain complex systems clearly. Solid product sense (8.0/10) ensures features align with user needs.\n\n⚠️ **Trade-off:** Less exposure to high-scale infrastructure patterns (6.5/10) compared to top candidates with distributed systems experience.',
    spiderMap: [
      { label: 'Product & Business Sense', value: 8.0 },
      { label: 'Communication & Impact', value: 8.5 },
      { label: 'Scale & Complexity', value: 6.5 },
      { label: 'Velocity & Focus', value: 7.2 },
      { label: 'Robustness & Quality', value: 7.8 },
    ],
  ...
  },
  {
    ...
    title: '',
    avatarColor: '#8b5cf6',
    aiRanking: '🏆 **Archetype:** The Quality Guardian\n\n🟢 **Superpower:** Exceptional robustness & quality (9.2/10) with production-grade error handling and defensive coding patterns. Strong scale knowledge (8.0/10) ensures systems stay reliable under load.\n\n⚠️ **Trade-off:** Lower development velocity (5.5/10) and communication impact (6.0/10) may slow feature delivery and team alignment.',
    spiderMap: [
      { label: 'Product & Business Sense', value: 7.5 },
      { label: 'Communication & Impact', value: 6.0 },
      { label: 'Scale & Complexity', value: 8.0 },
      { label: 'Velocity & Focus', value: 5.5 },
      { label: 'Robustness & Quality', value: 9.2 },
    ],
  ...
  },
  {
    ...
    title: '',
    avatarColor: '#f59e0b',
    aiRanking: '🏆 **Archetype:** The Frontend Specialist\n\n🟢 **Superpower:** Strong product sense (8.3/10) and communication (7.8/10) make them excellent for user-facing features. Good velocity (7.0/10) ensures consistent feature delivery.\n\n⚠️ **Trade-off:** Limited backend/infrastructure experience (4.5/10) means they may struggle with API design and distributed systems work.',
    spiderMap: [
      { label: 'Product & Business Sense', value: 8.3 },
      { label: 'Communication & Impact', value: 7.8 },
      { label: 'Scale & Complexity', value: 4.5 },
      { label: 'Velocity & Focus', value: 7.0 },
      { label: 'Robustness & Quality', value: 6.8 },
    ],
